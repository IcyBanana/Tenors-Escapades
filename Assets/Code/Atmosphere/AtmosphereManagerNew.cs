...
public class AtmosphereManagerNew : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown("k") || Input.GetKeyDown("j")) {
        ...
        sunMoon.rotation = Quaternion.Euler(0f, 0f, -tod * 360f);
        moon.rotation = Quaternion.Euler(0f, 0f, -sunMoon.rotation.z);
        sun.rotation = Quaternion.Euler(0f, 0f, -sunMoon.rotation.z);
    ...
    void OnValidate() {
        ...
        moon.rotation = Quaternion.Euler(0f, 0f, -sunMoon.rotation.z);
        sun.rotation = Quaternion.Euler(0f, 0f, -sunMoon.rotation.z);
        //sky.rotation = Quaternion.Euler(90f + tod * 360f, 90f, -90f);
